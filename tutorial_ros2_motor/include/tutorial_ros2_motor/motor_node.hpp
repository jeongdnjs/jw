...
#include <std_msgs/msg/string.hpp>  // String 메시지 헤더 파일 추가
...
private:
  ...
  void RobotCommandCallback(const std_msgs::msg::String::SharedPtr msg); // robot_command 콜백 함수 선언

  rclcpp::TimerBase::SharedPtr timer_;
  rclcpp::Subscription<std_msgs::msg::Int64MultiArray>::SharedPtr subscription_;
  rclcpp::Subscription<std_msgs::msg::String>::SharedPtr robot_command_subscription_; // robot_command 구독자 선언
  size_t count_;
};
